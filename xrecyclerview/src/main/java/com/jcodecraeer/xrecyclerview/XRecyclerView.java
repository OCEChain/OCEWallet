...
public class XRecyclerView extends RecyclerView {
    ...
    public void setHeaderBackgroundColor(int color) {
        getDefaultRefreshHeaderView().setBackgroundColor(color);
    }

    public void setHeaderBackgroundResource(int resId) {
        getDefaultRefreshHeaderView().setBackgroundResource(resId);
    }

    public void setHeaderTextColor(int color) {
        getDefaultRefreshHeaderView().setTexttColor(mRefreshHeader.getContext().getResources().getColor(color));
    }
