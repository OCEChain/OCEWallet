...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    int shadow = Color.parseColor("#cc222222");
    int transparent = Color.parseColor("#00222222");
    ...
    private void createGuideView() {
        ...
        if (customGuideView != null) {
            ...
            if (direction != null) {
                ...
                int left = center[0] - targetView.getWidth()/2 - radius;
                int right = center[0] - targetView.getWidth()/2 + radius;
                int top = center[1] - targetView.getHeight()/2 - radius;
                int bottom = center[1] - targetView.getHeight()/2 + radius;
                switch (direction) {
                    case TOP:
