...
//    }
    ...
    public static int dip2px(float dipValue) {
        float scale = OCEWalletApplication.getsInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        float fontScale = OCEWalletApplication.getsInstance().getResources().getDisplayMetrics().scaledDensity;
