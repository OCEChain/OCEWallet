...
import com.oce.ocewallet.ui.presenter.WalletDetailPresenter;
...
import com.oce.ocewallet.view.PrivateKeyDerivetDialog;
...
public class WalletDetailActivity extends BaseActivity implements WalletDetailContract.View {
    ...
    @Override
    public void modifyPwdSuccess(OCEWallet wallet) {
